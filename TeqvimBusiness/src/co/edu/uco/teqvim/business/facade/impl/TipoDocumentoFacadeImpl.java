...
import co.edu.uco.teqvim.crosscutting.utils.Messages.TipoDocumentoFacadeImplMessages;
...
public final class TipoDocumentoFacadeImpl implements TipoDocumentoFacade {
	...
	public List<TipoDocumentoDTO> list(TipoDocumentoDTO dto) {
		try {
			...
			var userMessage = TipoDocumentoFacadeImplMessages.LIST_EXCEPTION_USER_MESSAGE;
			var technicalMessage = TipoDocumentoFacadeImplMessages.LIST_EXCEPTION_TECHNICAL_MESSAGE;
	...
	@Override
	public void register(TipoDocumentoDTO dto) {
		try {
			final var domain = TipoDocumentoAssembler.getInstance().toDomainFromDto(dto);
			...
			var userMessage = TipoDocumentoFacadeImplMessages.REGISTER_EXCEPTION_USER_MESSAGE;
			var technicalMessage = TipoDocumentoFacadeImplMessages.REGISTER_EXCEPTION_TECHNICAL_MESSAGE;
