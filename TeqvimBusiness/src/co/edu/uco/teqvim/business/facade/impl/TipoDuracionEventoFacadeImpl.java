...
public final class TipoDuracionEventoFacadeImpl implements TipoDuracionEventoFacade{
	...
	@Override
	public void register(TipoDuracionEventoDTO dto) {
		try {
			final var domain = TipoDuracionEventoAssembler.getInstance().toDomainFromDto(dto);
			...
			var userMessage = TipoDuracionEventoFacadeImplMessages.REGISTER_EXCEPTION_USER_MESSAGE;
			var technicalMessage = TipoDuracionEventoFacadeImplMessages.REGISTER_EXCEPTION_TECHNICAL_MESSAGE;
